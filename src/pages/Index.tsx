      ...
      <div className="relative z-10 container mx-auto px-4 min-h-screen flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-6 mb-6 animate-fadeIn [animation-delay:600ms]">
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 hover:bg-white/10 backdrop-blur-sm"
            >
        ...
        <div className="relative z-20 mt-32 mb-8 animate-fadeIn">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-purple-600 to-blue-600 rounded-full hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
